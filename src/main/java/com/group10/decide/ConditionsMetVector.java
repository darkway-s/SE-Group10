...
public class ConditionsMetVector {
     ...
     * @param aPts      the number of consecutive points between the first and second point in the set
     * @param bPts      the number of consecutive points between the second and third in the set
     * @param radius1   the radius to compare to
     * @param points    the points
     ...
     * @param cPts      the nr. of points between the first and second point in the set
     * @param dPts      the nr. of points between the second and third point in the set
     * @param points    the points
     * @return          if such set exist
     */
